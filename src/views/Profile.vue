    ...
    <div class="profile-top uk-box-shadow-small">
      <div class="container-fluid">
        <div class="row">
          <div class="col-6 text-left margin-t padding-r">
            <img v-if="currentUser" class="img-alert" src="@/assets/panel/img/icon/alert.svg" alt />
          </div>
      ...
      <div class="user-info">
        <div v-if="currentUser">
          <img v-if="currentUser.user.pic.length > 0" :src="currentUser.user.pic" alt="user-image" />
